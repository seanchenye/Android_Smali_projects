...
.method public static commitContent(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/support/v13/view/inputmethod/InputContentInfoCompat;ILandroid/os/Bundle;)Z
    ...
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI"
    ...
    .line 116
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION"
    ...
    .line 118
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS"

    invoke-virtual {v2, v4, p3}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 119
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS"

    invoke-virtual {v2, v4, p4}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    .line 121
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT"
...
.method public static createWrapper(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/support/v13/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Landroid/view/inputmethod/InputConnection;
    ...
    const-string/jumbo v3, "inputConnection must be non-null"
    ...
    const-string/jumbo v3, "editorInfo must be non-null"
    ...
    const-string/jumbo v3, "onCommitContentListener must be non-null"
...
.method static handlePerformPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v13/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Z
    ...
    .line 57
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT"
    ...
    .local v7, "result":Z
    :try_start_0
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER"
    ...
    .line 67
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI"
    ...
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION"
    ...
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI"
    ...
    .line 72
    .local v3, "flags":I
    const-string/jumbo v9, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS"
